...
let TextureArray = [["Clouds_2K.png","Bump_2K.png","Dust_2K.png",'Mars_Diffuse_2K.png'],['base_color.jpg'],['Earth_Bump_2K.png','Earth_Clouds_2K.png','Earth_Diffuse_2K.png'],['Mercury_Bump_1K.png','Mercury_Diffuse_1K.png'],['Venus_Atmosphere_2K.png','Venus_Diffuse_1K.png']]; // store texture
/**
...
let camera;
let load_model = 0;
let translate_list = [[-1.0, -0.5, -6.0],[-8.0,-0.5,-6.0],[-11.0,-0.5,-2],[8.0,-0.5,-3.0],[-4.0, -0.5, -9.0]];
let model_load_list = [];
...
function myMain() {
    ...
    */
    ...
    camera = new Camera();
    // let model_num = 0;
    loadExternalJSON('./model/Mars 2K.json',0);
    loadExternalJSON('./model/Moon_2K.json',1);
    loadExternalJSON('./model/Earth 2K.json',2);
    loadExternalJSON('./model/Mercury 1K.json',3);
    loadExternalJSON('./model/Venus_1K.json',4);
...
function initBuffers(gl,idx) {
  ...
  function drawScene(gl, programInfo, buffers, texture, camera_view_matrix,now) {
    ...
    for (idx=0;idx<total;idx++){
      ...
      model_idx = model_load_list[idx][0];
      mat4.translate(
        modelMatrix_s, 
        modelMatrix_s, 
        [0.5, 2.0, -5.0]
      ); 
      mat4.rotate(modelMatrix_s,modelMatrix_s,now*2,[0.0,1.0,0.0]);
      // console.log(translate_list[model_idx]);
      mat4.translate(
        modelViewMatrix, 
        modelViewMatrix, 
      ...
      mat4.rotate(modelViewMatrix, modelViewMatrix, now, [0.0, 1.0, 0.0]);
      ...
      gl.uniform3fv(programInfo.uniformLocations.lightDirection, [0.5, 2.0, -5.0]);
